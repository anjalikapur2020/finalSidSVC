...
netimgright=loadImage("netright.PNG")
}
...
if (begin === 0){
  ...
  if (gameState === "about"){
    ...
    textSize(50)
text("Save the EARTH...Before It's Too Late..",width/5,100)

    textSize(25)
    fill("red")
    stroke("black")
  
    text("As all over the earth we humans are being destructive towards the envoirment. Everyday 18M people drink polluted water",70,300)
text("as we are polluting the water. Here you have a chance play the Game and make a habit of keeping water pure",70,350)

text("and saving every drop as a responsible human being come and save water and aware people about it as much as you can.",70,400)

text("The game consists of two levels, you have to clear both the levels in order to get the certificate and become a responsible citizen.",70,450)
